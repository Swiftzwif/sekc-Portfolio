...
import { MailIcon, BriefcaseIcon, CodeIcon } from '@/components/icons';

const contactMethods = [
  {
    label: 'Email',
    value: 'jaymisonsanchez@example.com',
    href: 'mailto:jaymisonsanchez@example.com',
    icon: <MailIcon size={40} />,
  },
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/jaymison',
    href: 'https://linkedin.com/in/jaymison',
    icon: <BriefcaseIcon size={40} />,
  },
  {
    label: 'GitHub',
    value: 'github.com/jaymison',
    href: 'https://github.com/jaymison',
