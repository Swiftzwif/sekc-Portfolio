  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h2 className="text-[clamp(2.5rem,6vw,5rem)] font-bold leading-[1.1] tracking-[-0.02em] mb-12 max-w-5xl mx-auto text-foreground">
        ...
        >
          <p className="text-[clamp(1.25rem,2.5vw,2rem)] text-text-secondary leading-relaxed mb-16">
            I build websites that actually work for your business.
          </p>
          <p className="text-[clamp(1rem,1.5vw,1.25rem)] text-text-secondary leading-relaxed mb-12">
        ...
        <motion.div
          ...
          className="text-center mt-24 pt-24 border-t border-border"
        >
          <p className="text-xl text-text-secondary mb-8 max-w-3xl mx-auto">
            Hi, I'm Jaymison Sanchez. Based in Boston, MA.
          </p>
          <p className="text-lg text-text-secondary/80 mb-12 max-w-3xl mx-auto">
