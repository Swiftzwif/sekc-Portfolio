...
export const BrainIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M9.5 2a2.5 2.5 0 0 1 2.5 2.5v.838a3.838 3.838 0 0 1 3.444 1.218A3.838 3.838 0 0 1 19 10.07V16a5 5 0 0 1-10 0v-5.93a3.838 3.838 0 0 1 3.556-3.514V5.5A2.5 2.5 0 0 1 14.5 2" />
    <path d="M16.855 11.532A3.838 3.838 0 0 0 15 8.236V5.5a.5.5 0 0 0-1 0v2.736a3.838 3.838 0 0 0-1.855 3.296" />
  </svg>
);
